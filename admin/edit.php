		  ...
		  <div class="questions">
			...
			<table width="735" height="388" border="0">
              <tr>
				...
				<?php
					$quesid=$_POST['number'];
					$a="select * from quiz_questions where qid=$quesid";
					$b=mysql_query($a);
					$c=mysql_fetch_array($b);
					echo "<form action='update.php?quesid=$quesid' method='post'>
				<table width='482'>
				  <tr class='table'>
			      <td width='145'>Enter Question</td><td width='325'><textarea cols='30' rows='3' name='ques' id='ques'>
				  </textarea></td></tr>";
				  ?>
				  <script language='javascript'>document.getElementById('ques').value='<?php echo $c['question']; ?>';
		</script>
				<?php
				 echo "<tr class='table'>
			      <td>Enter Option1</td><td><input type='text' name='op1' id='op1' /></td></tr>";
				  ?>
				  <script language='javascript'>document.getElementById('op1').value='<?php echo $c['option1']; ?>';
		</script>
				  <?php
				  echo "<tr class='table'>
				  ...
				  ?>
				  <script language='javascript'>document.getElementById('op2').value='<?php echo $c['option2']; ?>';
		</script>
				  <?php
				  echo "<tr class='table'>
			      <td>Enter Option3</td><td><input type='text' name='op3' id='op3' /></td></tr>";
				  ?>
				  <script language='javascript'>document.getElementById('op3').value='<?php echo $c['option3']; ?>';
		</script>
				  <?php
				  echo "<tr class='table'>
			      <td>Enter Option4</td><td><input type='text' name='op4' id='op4' /></td></tr>";
				  ?>
				  <script language='javascript'>document.getElementById('op4').value='<?php echo $c['option4']; ?>';
		</script>
				  <?php

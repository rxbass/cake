...
<div class="main">
		...
		<div class="content">
		  ...
		  <div class="questions">
			...
			<p style=" font-family:'Trebuchet MS'; font-size:16px; text-indent:200px; font-weight:bold; color:#FFFFFF;">Delete Question -  Admin Panel </p>
     ...
     while ($k=mysql_fetch_array($j))
	{
		...
		echo "<div class='table'>Mark Checkbox to delete Question<input type='checkbox' name='che[]' value='".$k['qid']."' /><br/>
	...
	{
		echo "<a href='deleteques.php?pag=$npag'  class='nebk'>||>>next|</a>";
	}
	if($control2 >= 0)
	{
		echo "<a href='deleteques.php?pag=$bpag' class='nebk'>|>>back||</a>";
	}
